            ...
            <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                ...
                <div class="card-body p-5 text-center">
                    ...
                    <div class="form-outline form-white mb-4">
                        <input type="name" id="typeNmailX" class="form-control form-control-lg" />
                    ...
                    <div class="form-outline form-white mb-4">
                        <input type="confirmPassword" id="retypePasswordX" class="form-control form-control-lg" />
                        <label class="form-label" for="retypePasswordX">Confirm Password</label>
                    </div>

                    <button class="btn btn-outline-warning btn-lg px-5 mb-4" type="submit">Register</button>
